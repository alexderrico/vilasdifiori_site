...
export default function Footer() {
  return (
    <footer className="bg-brown-dark border-t border-white/5">
          ...
          <nav className="flex flex-wrap items-center justify-center gap-1">
            {nav.links.map((link) => (
              <a
                key={link.href}
                href={link.href}
                className="text-white/50 hover:text-white hover:bg-white/5 text-sm font-medium tracking-wide px-3 py-1.5 rounded-full transition-all duration-300"
              >
                {link.label}
              </a>
            ))}
